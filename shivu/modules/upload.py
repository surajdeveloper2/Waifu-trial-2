...
rarity_map = 1 (⚪️ Common), 2 (🟠 Rare) , 3 (🟢 Medium) , 4 (🟡 Legendary) , 5 (💠 Exclusive) , 6 (🔮 Limited Edition)"""
...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟠 Rare", 3: "🟢 Medium", 4: "🟡 Legendry", 5: "💠 Exclusive", 6: "🔮 Limited Edition"}
        try:
