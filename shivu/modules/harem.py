...
async def add_rarity(update: Update, context: CallbackContext) -> None:
    ...
    rarities = ["⚪ 𝐂𝐨𝐦𝐦𝐨𝐧" , "🟣 𝐍𝐨𝐫𝐦𝐚𝐥" , "🔵 𝐌𝐞𝐝𝐢𝐮𝐦" , "🎗️ 𝐋𝐞𝐠𝐞𝐧𝐝𝐚𝐫𝐲" , "💮 𝐒𝐩𝐞𝐜𝐢𝐚𝐥 𝐄𝐝𝐢𝐭𝐢𝐨𝐧" , "🔮 𝐋𝐢𝐦𝐢𝐭𝐞𝐝 𝐄𝐝𝐢𝐭𝐢𝐨𝐧" , "🫧 𝐏𝐫𝐞𝐦𝐢𝐮𝐦" , "🎃 𝐇𝐚𝐥𝐥𝐨𝐰𝐞𝐞𝐧" , "💞 𝐕𝐚𝐥𝐞𝐧𝐭𝐢𝐧𝐞" , "🌲 𝐂𝐡𝐫𝐢𝐬𝐭𝐦𝐚𝐬" , "🐰 𝐁𝐮𝐧𝐧𝐲" , "🫦 𝐒𝐞𝐱𝐲" , "🍑 𝐒𝐮𝐥𝐭𝐫𝐲" , "🥵 𝐇𝐞𝐚𝐯𝐞𝐧"]
...
async def add_rarity_callback(update: Update, context: CallbackContext) -> None:
    ...
    if data == "add_rarity:Default":
        ...
        rarities = ["⚪ 𝐂𝐨𝐦𝐦𝐨𝐧", "🟣 𝐍𝐨𝐫𝐦𝐚𝐥" , "🔵𝐌𝐞𝐝𝐢𝐮𝐦" , "🎗️ Legendary" , "💮 𝐌𝐲𝐭𝐡𝐢𝐜𝐚𝐥" , "🔮 𝐋𝐢𝐦𝐢𝐭𝐞𝐝 𝐄𝐝𝐢𝐭𝐢𝐨𝐧" , "🫧 𝐏𝐫𝐞𝐦𝐢𝐮𝐦" , "🎃 𝐇𝐚𝐥𝐥𝐨𝐰𝐞𝐞𝐧" , "💞 𝐕𝐚𝐥𝐞𝐧𝐭𝐢𝐧𝐞" , "🌲 𝐂𝐡𝐫𝐢𝐬𝐭𝐦𝐚𝐬" , "🐰𝐁𝐮𝐧𝐧𝐲" , "🫦 𝐒𝐞𝐱𝐲" , "🍑 𝐒𝐮𝐥𝐭𝐫𝐲" , "🥵 𝐇𝐞𝐚𝐯𝐞𝐧"]
        # Arrange rarities in rows of two
        keyboard = []
        for i in range(0, len(rarities), 2):
