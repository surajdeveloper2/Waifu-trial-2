...
async def add_rarity(update: Update, context: CallbackContext) -> None:
    ...
    rarities = ["⚪ 𝐂𝐨𝐦𝐦𝐨𝐧", "🟣 𝐍𝐨𝐫𝐦𝐚𝐥", "🔵𝐌𝐞𝐝𝐢𝐮𝐦", "🎗 𝐋𝐞𝐠𝐞𝐧𝐝𝐚𝐫𝐲", "💮 𝐒𝐩𝐞𝐜𝐢𝐚𝐥 𝐄𝐝𝐢𝐭𝐢𝐨𝐧", "🔮𝐋𝐢𝐦𝐢𝐭𝐞𝐝 𝐄𝐝𝐢𝐭𝐢𝐨𝐧", "🫧𝐏𝐫𝐞𝐦𝐢𝐮𝐦", "🎃𝐇𝐚𝐥𝐥𝐨𝐰𝐞𝐞𝐧", "💞𝐕𝐚𝐥𝐞𝐧𝐭𝐢𝐧𝐞", "🌲𝐂𝐡𝐫𝐢𝐬𝐭𝐦𝐚𝐬", "🐰𝐁𝐮𝐧𝐧𝐲", "🫦𝐒𝐞𝐱𝐲", "🍑𝐒𝐮𝐥𝐭𝐫𝐲", "🥵𝐇𝐞𝐚𝐯𝐞𝐧"]
...
harem_handlfrom telegram import Update
from itertools import groupby
import urllib.request
import re
import math
...
er = CallbackQueryHandler(harem_callback, pattern='^harem', block=False)
application.add_handler(harem_handler)
